         ...
         <br />
            <dx:ASPxPivotGrid ID="ASPxPivotGrid1" runat="server" ClientIDMode="AutoID" DataSourceID="SqlDataSource1"
                ...
                <Fields>
                    ...
                    <dx:PivotGridField ID="fieldEOYTotalReadingLessonsonBlackBoard" 
                        FieldName="EOY_TotalReadingLessonsonBlackBoard" AreaIndex="7">
                    </dx:PivotGridField>
                    <dx:PivotGridField ID="fieldEOYBBReadingScore" FieldName="EOY_BB-ReadingScore"
                        AreaIndex="8">
                    </dx:PivotGridField>
                    <dx:PivotGridField ID="fieldStudyIslandWeeksUsed" 
                        FieldName="Study-IslandWeeksUsed" AreaIndex="9">
                    </dx:PivotGridField>
                    ...
                    <dx:PivotGridField ID="fieldStudyIslandQuestions" 
                        FieldName="StudyIslandQuestions" AreaIndex="13">
                    </dx:PivotGridField>
                    ...
                    <dx:PivotGridField ID="fieldEOYProblemSolvingScore" 
                        FieldName="EOY-Problem-SolvingScore" AreaIndex="25">
                    </dx:PivotGridField>
                </Fields>
